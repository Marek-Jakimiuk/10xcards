...
export type FlashcardDTO = Pick<FiszkaRow, "id" | "przod" | "tyl" | "status">;

// 2. FlashcardDetailDTO
// Used to retrieve a single flashcard (GET /api/flashcards/{id}). It extends FlashcardDTO with deck_id (from deck_id).
